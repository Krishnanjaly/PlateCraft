...
const Alert=()=>{ alert("Please login to continue..")
  };
            ...
            <div className="third">
                <div className="one">
                    ...
                    <ul onClick={Alert}>
                        ...
                        <li>Turmeric-Infused Comfort</li>
                    </ul>
                </div>
                <div className="two">
                    <h2>Spicy Foods</h2>
                    <ul onClick={Alert}>
                        <li>Vindaloo (India)</li>
                        ...
                        <li>Berbere Chicken Stew (Ethiopia) </li>
                    </ul>
                </div>
                <div className="three">
                    <h2>Sugary Foods</h2>
                ...
                <div className="four">
                    ...
                    <ul onClick={Alert}>
                        ...
                        <li>Egg Bhurji / Scrambled Eggs </li>
                    </ul>
                </div>
                <div className="five">
                ...
                <div className="seven">
                    ...
                    <ul onClick={Alert}>
                        ...
                        <li>Eggplant in Garlic Sauce (鱼香茄子)</li>
                    </ul>
                </div>
                <div className="eight">
                    <h2>Breakfast</h2>
                ...
                <div className="ten">
                    ...
                    <ul onClick={Alert}>
                        ...
                        <li>Lemon Rice</li>
                        <li>Avial</li>
                        <li>Chettinad Chicken Fry</li>
                    </ul>
                </div>
                <div className="eleven">
                    <h2>North Indian Dishes</h2>
                    <ul onClick={Alert}>
                        <li>Chapati / Roti / Naan / Paratha</li>
                        <li>Gulab Jamun</li>
                        <li>Chole Bhature</li>
                        <li>Aloo Puri</li>
